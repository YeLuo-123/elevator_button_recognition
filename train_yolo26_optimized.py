...
Compared with train_yolo26.py, it uses gentler geometry augmentation, disables
...
DEFAULT_DATA = ROOT / "Elevator Buttons - Original Version.v10-augmented-dataset-size-3x.yolo26" / "data.yaml"
DEFAULT_MODEL = ROOT / "yolo26m.pt"
